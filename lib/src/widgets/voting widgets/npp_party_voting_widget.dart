...
class NppPartyVotingWidget extends StatefulWidget {
  const NppPartyVotingWidget({super.key});

  @override
  State<NppPartyVotingWidget> createState() => _NppPartyVotingWidgetState();
}

class _NppPartyVotingWidgetState extends State<NppPartyVotingWidget> {
  @override
