...
class GasPartyVotingWidget extends StatefulWidget {
  const GasPartyVotingWidget({super.key});

  @override
  State<GasPartyVotingWidget> createState() => _GasPartyVotingWidgetState();
}

class _GasPartyVotingWidgetState extends State<GasPartyVotingWidget> {
  @override
