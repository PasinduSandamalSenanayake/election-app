...
class SlppPartyWidget extends StatefulWidget {
  const SlppPartyWidget({super.key});

  @override
  State<SlppPartyWidget> createState() => _SlppPartyWidgetState();
}

class _SlppPartyWidgetState extends State<SlppPartyWidget> {
  @override
